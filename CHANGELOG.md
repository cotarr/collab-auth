...
- Bump eslint to version v9.15.0 to clear GitHub Dependabot audit warning.
- Update npm packages pg@8.13.1, uuid@11.0.3
...
- Update npm dependency ejs@3.1.0 to address GitHub dependabot security audit warning.
- Update npm dependency pg@8.11.5

## [v0.0.26](https://github.com/cotarr/collab-auth/releases/tag/v0.0.26) 2024-03-26
